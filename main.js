...
(function () {
  ...
  if (labModal) {
    ...
    var openLab = function (key) {
      ...
      labBody.innerHTML =
        ...
        (d.link ? '<a class="lmodal-repo" href="' + d.link.href + '" target="_blank" rel="noopener">' + d.link.label + ' <span aria-hidden="true">↗</span></a>' : '');
  ...
  (function () {
    /* card-face links: navigate without opening the card's modal */
  document.querySelectorAll('.bento-go').forEach(function (a) {
  ...
  /* --- knowledge base --- */
  var ANSWERS = {
    'what-pm': "Angela is a <strong>product builder and researcher</strong>. She combines hands-on AI development, HCI research, and design strategy to take problems nobody has scoped yet and make them tractable. Her background is unusual: Computer Science &amp; Philosophy, now finishing a master's in Human-Computer Interaction. In practice she builds and prototypes to test hypotheses, runs the research that grounds the decision, and scopes ruthlessly so the vital few things actually ship.",
    'intelligence': "Angela wrote a full essay on this (<em>Intelligence is becoming the unit of work</em>, in Writing). The short version: it's the question her philosophy degree never let her put down. She doesn't think intelligence is the ability to produce the right answer, since models do that constantly without understanding anything. It's closer to <em>judgment</em>: knowing which question is worth asking, what a result means in context, and when to override it. That's the gap she designs around. Her clinical AI work taught her this directly. The model could classify, but trust came from surfacing its reasoning at the exact moment a pathologist needed to exercise <em>their</em> judgment. In the age of AI, intelligence stops being about generating answers and starts being about deciding what to do with them.",
    'clinical': "At <strong>UChicago Medicine</strong>'s SlideFlow Labs, Angela owned validation for an AI diagnostic tool for thyroid pathology that had never been tested outside the team that built it. She reframed it from “does this feature work” to “does this tool earn a place in a pathologist's workflow.” Working across 12+ pathologists at 3 hospitals, the team moved from a black-box output to a <em>glass-box</em> interface, and trust ratings went from scattered across the scale to the top two categories on every metric. The client productionized the recommendations and revised their go-to-market.",
    'method': "At <strong>Method</strong>, a 300-person consultancy, institutional knowledge lived in people rather than systems: when someone left, their expertise left too. Angela owned stakeholder alignment in a room of 20+, C-suite included, and designed a DVF workshop that scored every concept <em>before</em> discussion, so the loudest voice couldn't set the roadmap. The team shipped an AI knowledge platform in 3 months that cut document discovery from 5–6 hours to under 3 minutes.",
    'education': "For <strong>Education First Consulting</strong> her client is the U.S. Department of Education, on a national data program touching 500K+ students, ongoing through December 2026. Angela aligned 30+ federal, state, and district stakeholders on scope, and is now designing and building first-of-their-kind data visualization prototypes for government education testing, applying LLMs to surface prediction uncertainty over longitudinal data. The stakeholder interviews were too sensitive for a third-party API, so she built a fully local RAG pipeline the team could query without the data ever leaving the machine.",
    'lab': "Angela builds her own tools, usually to answer a question nothing off-the-shelf could. <strong>From Data to Action</strong> is a live experiment with 50+ professionals testing whether different data interfaces actually improve decision quality. <strong>Voice Of</strong> is a fully local RAG pipeline, so sensitive interview data never leaves the machine. <strong>Job Fit Analyzer</strong> is a Chrome extension that turns ten minutes of copy-pasting into a one-click fit score. And the <strong>Analysis dashboard</strong> is the Streamlit app she built to interrogate her own study data. Every one of them links to something you can open: a live experiment, demo videos, public repos. Her view: the best way to understand a new technology is to make it do something useful.",
    'approach': "Three moves, mostly. <strong>Translate</strong>: she finds shared language between clinicians, engineers, executives, and agencies so everyone ships the same thing. <strong>Build</strong>: when no tool fits, she makes one, so she can talk to engineers with real context. <strong>Scope</strong>: run the workshop, prioritize the vital few, cut the rest. Smaller, but shippable.",
    'about': "Angela grew up in <strong>Napoli, Italy</strong>, with the Amalfi Coast a short drive away, and moved to the U.S. six years ago. She has played classical piano for seventeen years, and says it taught her that the unglamorous daily work is what actually compounds. Off the clock: novels on a beach, R&amp;B concerts, squash, and building small utilities nobody asked for.",
    'synthetic': "Angela just wrote about this: <em>Research from non-people</em>, in the Writing section. Short version: synthetic users are fine for rehearsal and dangerous as evidence. Copies of copies lose the edges of the distribution (Shumailov et al. call it model collapse), and the edges are what research exists to find. Her rule: keep provenance first-class, and protect a budget of real human contact per project. She practices what she preaches. Her Voice Of tool simulates stakeholders, but it's grounded in real interview transcripts.",
    'globallogic': "At <strong>GlobalLogic</strong> (Hitachi Group) Angela built a <strong>LangGraph-based multi-agent system</strong> for consulting sales experts: solo, in 6 weeks, from product definition through evaluation and deployment. It automates account research and draft structure while the expert's voice and judgment stay in the loop. Evaluated on citation retrieval accuracy, hallucinated metric references, and LLM-as-Judge agreement (DeepEval); time-to-draft fell from a 2+ hour expert baseline to about 5 minutes in evaluated runs. It's called <strong>SPIS</strong>, the Sales Prospecting Intelligence System, and a sanitized version of the code is public on GitHub, linked from the case study in the Work section.",
    'last-project': "Her most recent shipped work is at <strong>GlobalLogic</strong>: a LangGraph multi-agent system for sales experts, built solo in 6 weeks. Time-to-draft went from a 2+ hour expert baseline to about 5 minutes in evaluated runs, with quality gated by deterministic and LLM-as-Judge evals. Alongside it, the project Angela is deepest in is <strong>From Data to Action</strong>, a live experiment testing whether tables, dashboards, data stories, or conversational AI actually improve <em>decision quality</em>. She built the whole eval end to end (React, Supabase, Claude API, Python); 50+ professionals are enrolled so far. It's the clearest expression of how she thinks about data products: measure them on the decisions they enable rather than on engagement.",
    'tech': "Angela hand-built this site: static HTML, CSS, and vanilla JavaScript, no framework. The display type is <strong>Bricolage Grotesque</strong> with <em>Instrument Serif</em> for the italic accents. This chat is a lightweight responder running entirely in your browser; nothing leaves the page. Analytics are cookieless PostHog: nothing is stored on your device. In a production build she'd wire it to the Claude API with her work as the knowledge base.",
    'contact': "Angela is open to full-time roles starting <strong>January 2027</strong>, especially AI product, hybrid builder, and research-heavy product roles. The best way to reach her is <a href=\"mailto:apetronedesign@gmail.com\">apetronedesign@gmail.com</a>, or find her on <a href=\"https://www.linkedin.com/in/apetrone02\" target=\"_blank\" rel=\"noopener\">LinkedIn ↗</a>. She's happy to talk about anything she's worked on.",
    'why-hire': "The pattern across everything Angela has done is the same: she gets handed something undefined and hands back something a team can build. At GlobalLogic that meant designing, building, and evaluating a multi-agent system on her own in five weeks. At UChicago Medicine it meant earning the trust of pathologists who initially declined to rate the tool at all. With the Department of Education it means getting thirty-plus stakeholders to agree on what to build in the first place. She's most useful in rooms where the problem hasn't been scoped yet, and she stays long enough to ship.",
    'evals': "During her latest project at GlobalLogic, Angela ended up caring about the evaluation suite as much as the system itself: deterministic checks for citations and hallucinated metrics, an LLM-as-Judge for the qualities that resist hard rules, and an audit of the judge itself, because a quality gate nobody checks becomes the weakest link in the pipeline. The same instinct runs through her research. She wrote an essay arguing that data products should be measured on the decisions they enable, and <strong>From Data to Action</strong> is that idea running as a live experiment with 50+ professionals.",
    'ai-tools': "Her stack assumes AI in the loop: Claude Code and Cursor for building, plus her own projects for finding the limits. The local RAG pipeline, the Chrome extension, the analysis dashboard: each one started as a question Angela wanted answered faster than she could answer it by hand. That habit changed how she thinks about buy versus build, and she wrote an essay working through exactly that. The judgment calls stay hers: what to build, what the output means, and when it's wrong.",
    'location': "Angela is currently based in Chicago and is open to relocation in the United States.",
    'salary': "That's a conversation for the real Angela. She's reasonable, and she'd rather hear about the role first: <a href=\"mailto:apetronedesign@gmail.com\">apetronedesign@gmail.com</a>.",
    'support': "That sounds heavy, and a portfolio chatbot is not the right help. If you are in the U.S., you can call or text <strong>988</strong> to reach the Suicide &amp; Crisis Lifeline, any time. Please reach out to someone.",
    'boundary': "I'll pass on that one. This chat sticks to Angela's work, her projects, and how she thinks. If you have a question about any of those, I'm happy to help.",
    'fallback': "That one's beyond me. The real Angela answers email fast: <a href=\"mailto:apetronedesign@gmail.com\">apetronedesign@gmail.com</a>. Or ask me about her work, her Lab projects, or how she thinks about AI."
  };
  var ROUTES = [
    { k: ['suicide', 'kill myself', 'self-harm', 'self harm', 'hurt myself', 'end my life'], a: 'support' },
    { k: ['fuck', 'shit', 'bitch', 'asshole', 'bastard', 'cunt', 'whore', 'slut', 'nigg', 'fag', 'retard', 'porn', 'nsfw', 'nude', 'naked', 'sexual', 'sexy', 'hate you', 'hate her', 'hate angela', 'you suck', 'she sucks', 'angela sucks', 'stupid bot', 'dumb bot', 'shut up', 'bomb', 'weapon', 'malware', 'hack into'], a: 'boundary' },
    ...
    { k: ['technolog', 'tech ', 'stack', 'website', 'this site', 'this chat', 'built', 'framework', 'how did you make', 'how did she make', 'who made this'], a: 'tech' },
    { k: ['approach', 'how do you work', 'how does she work', 'how does angela work', 'her process', 'her approach', 'translate', 'scope', 'process', 'method of work', 'how you work'], a: 'approach' },
    { k: ['napoli', 'italy', 'piano', 'hobby', 'hobbies', 'personal', 'yourself', 'who are you', 'about you', 'about her', 'about angela', 'her background', 'where is she from', 'where is angela from', 'squash', 'music', 'fun'], a: 'about' },
    { k: ['why should we hire', 'why hire', 'why you', 'why her', 'why angela', 'strengths', 'stand out', 'good fit'], a: 'why-hire' },
    { k: ['eval', 'measure quality', 'benchmark', 'llm-as-judge', 'llm as judge', 'how do you test', 'how does she test', 'how does angela test'], a: 'evals' },
    { k: ['claude code', 'cursor', 'copilot', 'ai tools', 'use ai', 'ai-assisted', 'ai assisted', 'vibe cod'], a: 'ai-tools' },
    { k: ['chicago', 'new york', 'boston', 'd.c.', 'washington', 'san francisco', 'relocat', 'remote', 'location', 'where are you based', 'where is she', 'where is angela', 'where does she live', 'where does angela live', 'based in', 'based?'], a: 'location' },
    { k: ['salary', 'compensation', 'comp package', 'pay', 'money', 'how much do you', 'how much are you', 'how much does she', 'how much does angela', 'how much is she'], a: 'salary' },
    { k: ['contact', 'hire', 'hiring', 'available', 'availab', 'email', 'reach', 'resume', 'résum', 'linkedin', 'get in touch', 'role'], a: 'contact' },
    { k: ['pm', 'product manager', 'what kind of', 'what do you do', 'what does angela do', 'what does she do', 'who is angela', 'who is she', 'who', 'role'], a: 'what-pm' }
  ];
  function route(text) {
