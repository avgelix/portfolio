...
(function () {
  ...
  /* --- knowledge base --- */
  var ANSWERS = {
    'what-pm': "Angela is a <strong>product builder and researcher</strong>. She combines hands-on AI development, HCI research, and design strategy to take problems nobody has scoped yet and make them tractable. Her background is unusual: Computer Science &amp; Philosophy, then a master's in Human-Computer Interaction. In practice she builds and prototypes to test hypotheses, runs the research that grounds the decision, and scopes ruthlessly so the vital few things actually ship.",
    ...
    'salary': "That's a conversation for the real Angela. She's reasonable, and she'd rather hear about the role first: <a href=\"mailto:apetrone@hawk.illinoistech.edu\">apetrone@hawk.illinoistech.edu</a>.",
    ...
    'fallback': "Honest answer: I'm a lightweight on-page responder, not a full model, and that one's beyond my script. The real Angela answers email fast, though: <a href=\"mailto:apetrone@hawk.illinoistech.edu\">apetrone@hawk.illinoistech.edu</a>. Or ask me about her work, her Lab projects, or how she thinks about AI: that I can do."
  };
  var ROUTES = [
